...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const predictionScript = process.env.PREDICT_SCRIPT || path.join(__dirname, "../backend/predict.py");
    ...
    exec(`"${pythonCommand}" "${predictionScript}" "${imagePath}"`, { timeout: 120000 }, (error, stdout, stderr) => {
      if (error) {
